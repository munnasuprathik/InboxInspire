"""
Script to safely insert goals API endpoints into server.py
"""
...
# Find the line with @asynccontextmanager
insert_index = None
for i, line in enumerate(lines):
    if '@asynccontextmanager' in line:
        insert_index = i
        break

if insert_index is None:
    print("ERROR: Could not find @asynccontextmanager in server.py")
    exit(1)

print(f"Found @asynccontextmanager at line {insert_index + 1}")

# Goals endpoints code to insert
goals_code = '''
# ============================================================================
# GOALS API ENDPOINTS
# ============================================================================
...
# Insert the code
lines.insert(insert_index, goals_code)

# Write back
with open('server.py', 'w', encoding='utf-8') as f:
    f.writelines(lines)

print(f"✅ Successfully inserted goals endpoints before line {insert_index + 1}")
print("Goals API endpoints added successfully!")
